  ...
  return (
    <>
      <footer className='about__footer'>
        ...
        <div className="about__footer__author"><span><span>by</span></span><span><span><Button href='https://github.com/bartlomiejwiejak' type='black'>Bartłomiej Wiejak.</Button></span></span></div>
      </footer>
